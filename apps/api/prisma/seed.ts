...
async function main() {
  ...
  const zone = await prisma.shippingZone.upsert({ where: { id: '00000000-0000-0000-0000-000000000001' }, create: { id: '00000000-0000-0000-0000-000000000001', name: 'Development default', countries: ['US','PK'] }, update: {} });
  await prisma.shippingMethod.upsert({ where: { id: '00000000-0000-0000-0000-000000000001' }, create: { id: '00000000-0000-0000-0000-000000000001', zoneId: zone.id, name: 'Standard delivery', type: 'FLAT_RATE', basePrice: '10.0000' }, update: {} });
