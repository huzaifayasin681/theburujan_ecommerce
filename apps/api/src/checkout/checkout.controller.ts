...
class AddressDto { @IsString() @Length(1, 120) name!: string; @IsString() @Length(5, 32) phone!: string; @IsString() @Length(2, 64) country!: string; @IsString() @Length(1, 100) state!: string; @IsString() @Length(1, 100) city!: string; @IsString() @Length(1, 24) postalCode!: string; @IsString() @Length(1, 255) line1!: string; @IsOptional() @IsString() @Length(0, 255) line2?: string; }
